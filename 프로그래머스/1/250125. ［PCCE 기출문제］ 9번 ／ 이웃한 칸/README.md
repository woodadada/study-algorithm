...
<div class="highlight"><pre class="codehilite"><sider-code-explain id="sider-code-explain" data-gpts-theme="dark"></sider-code-explain><code>1. 정수를 저장할 변수 n을 만들고 board의 길이를 저장합니다.
