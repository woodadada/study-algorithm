...
2024년 05월 06일 23:45:31

### 문제 설명

<p data-sider-select-id="65333009-69aa-4171-9314-b057f8f6a2ec">어느 한 게임에서 사용되는 아이템들은 업그레이드가 가능합니다.<br>
...
<p data-sider-select-id="5b843756-0b00-45ac-9be3-6ba0fb1b5163"><code>ITEM_TREE</code> 테이블은 다음과 같으며, <code>ITEM_ID</code>, <code>PARENT_ITEM_ID</code>는 각각 아이템 ID, PARENT 아이템의 ID를 나타냅니다.</p>
<table class="table">
        <thead><tr>
<th>Column name</th>
<th>Type</th>
...
<p data-sider-select-id="cab17ac8-7b8f-4c3e-b33e-6330426eae55">아이템의 희귀도가 'RARE'인 아이템들의 모든 다음 업그레이드 아이템의 아이템 ID(ITEM_ID),  아이템 명(ITEM_NAME), 아이템의 희귀도(RARITY)를 출력하는 SQL 문을 작성해 주세요. 이때 결과는 아이템 ID를 기준으로 내림차순 정렬주세요.</p>
...
<th>PRICE</th>
        ...
        <tbody><tr>
<td>0</td>
<td data-sider-select-id="7bafbbb9-c4d1-4624-a4d1-c453a13b8b71">ITEM_A</td>
<td>RARE</td>
<td>10000</td>
</tr>
<tr>
...
<th>PARENT_ITEM_ID</th>
        ...
        <tbody><tr>
<td data-sider-select-id="afbf6d5c-8c91-4158-87f9-c76168eb527a">0</td>
<td>NULL</td>
</tr>
<tr>
<td>1</td>
...
<p data-sider-select-id="f6d3d943-16d3-47e1-8bdb-c5d90bb56e43">아이템의 희귀도가 'RARE'인 아이템은 'ITEM_A', 'ITEM_B', 'ITEM_D', 'ITEM_E' 입니다. <br>
